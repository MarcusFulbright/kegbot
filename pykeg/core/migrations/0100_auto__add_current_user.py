...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'current_user'
        db.create_table(u'core_current_user', (
        ...
        db.send_create_signal(u'core', ['current_user'])


    def backwards(self, orm):
        # Deleting model 'current_user'
        db.delete_table(u'core_current_user')
